							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
								  	<a class="dropdown-item" href="./?page=projects/view_project&id=<?php echo $row['id'] ?>" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
									<?php if($row['status'] != 2): ?>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item add_report" href="javascript:void(0)" data-id ="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>"><span class="fa fa-plus text-dark"></span> Add Report</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
        $('.add_report').click(function(){
			uni_modal("Add New Report to <b>"+$(this).attr('data-name')+"</b>","projects/manage_report.php?project_id="+$(this).attr('data-id'))
		})
